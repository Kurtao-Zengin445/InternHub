...
@section('page-subtitle', $evaluation->internship->student->user->name)
...
<div class="col-xl-8">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('school.evaluations.edit', $evaluation) }}" class="btn btn-outline-primary">
...
<div class="col-xl-4 d-flex flex-column gap-3">
    @php $student = $evaluation->internship->student; @endphp

    <div class="card">
        <div class="card-header"><i class="bi bi-person-fill text-primary me-2"></i>Info Siswa</div>
        <div class="card-body" style="font-size:13px;padding:16px 20px">
            ...
            <div class="d-flex justify-content-between mb-1">
                ...
                <span style="font-weight:500;text-align:right;max-width:160px">
                    {{ $evaluation->internship->program->company->name }}
                </span>
            </div>
    ...
    <div class="card">
        <div class="card-header">
            <i class="bi bi-building text-secondary me-2"></i>Nilai Perusahaan
        </div>
        <div class="card-body text-center" style="padding:20px">
            @if($companyEval)
                ...
                <div style="font-size:14px;font-weight:700;color:#64748b;margin-top:2px">
                    Grade {{ $companyEval->grade_letter }}
                </div>
            @else
                <div style="font-size:13px;color:#94a3b8">Belum dinilai oleh perusahaan</div>
            @endif
        </div>
    </div>
